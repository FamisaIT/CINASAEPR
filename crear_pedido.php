...
<div class="mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Crear Nuevo Pedido</li>
        </ol>
    </nav>
</div>
...
<div class="card shadow-lg border-0">
    <div class="card-header bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4">
        <h3 class="mb-0">
            <i class="fas fa-file-invoice mr-2"></i>Crear Nuevo Pedido
        </h3>
    </div>
    ...
    <div class="card-body p-4">
        <form id="formCrearPedido">
            ...
            <div class="mb-5">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-lg" id="numero_pedido" name="numero_pedido" placeholder="PED-001, OP-2024-001, etc." required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-4">
                    <div class="col-md-8 position-relative">
                        ...
                        <div class="input-group input-group-lg">
                            <input type="text" class="form-control" id="cliente_busqueda" placeholder="Buscar cliente..." autocomplete="off" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control form-control-lg" id="contacto" name="contacto" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="telefono" class="form-label">Teléfono</label>
                        <input type="text" class="form-control form-control-lg" id="telefono" name="telefono" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="correo" class="form-label">Correo</label>
                        <input type="email" class="form-control form-control-lg" id="correo" name="correo" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control form-control-lg" id="facturacion" name="facturacion" rows="4" placeholder="Dirección de facturación" required></textarea>
                    </div>
                    <div class="col-md-6">
                        <label for="entrega" class="form-label">Entrega (Ship To) <span class="text-danger">*</span></label>
                        <textarea class="form-control form-control-lg" id="entrega" name="entrega" rows="4" placeholder="Dirección de entrega" required></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <div>
                    <textarea class="form-control form-control-lg" id="observaciones" name="observaciones" rows="4" placeholder="Notas adicionales del pedido..."></textarea>
                </div>
            </div>
        </form>
    </div>
...
<!-- Modal para seleccionar producto (en caso de necesitarlo) -->
...
<script>
    ...
    <script src="<?php echo BASE_PATH; ?>/app/assets/crear_pedido.js?v=<?php echo time(); ?>"></script>
</body>
</html>
